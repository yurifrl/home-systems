...
class DummyRados(object):
    ...
    def _init_cmd_output_map(self):
        ...
        ] = """[{"entity":"client.healthchecker","key":"<<REDACTED>>","caps":{"mon":"allow r, allow command quorum_status","osd":"profile rbd-read-only, allow rwx pool=default.rgw.meta, allow r pool=.rgw.root, allow rw pool=default.rgw.control, allow x pool=default.rgw.buckets.index","mds":"allow *"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.csi-rbd-node","key":"<<REDACTED>>","caps":{"mon":"profile rbd, allow command 'osd blocklist'","osd":"profile rbd"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.csi-rbd-provisioner","key":"<<REDACTED>>","caps":{"mgr":"allow rw","mon":"profile rbd, allow command 'osd blocklist'","osd":"profile rbd"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.csi-cephfs-node","key":"<<REDACTED>>","caps":{"mds":"allow rw","mgr":"allow rw","mon":"allow r, allow command 'osd blocklist'","osd":"allow rw tag cephfs *=*"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.csi-cephfs-provisioner","key":"<<REDACTED>>","caps":{"mgr":"allow rw","mon":"allow r, allow command 'osd blocklist'","osd":"allow rw tag cephfs metadata=*","mds":"allow *"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.csi-cephfs-provisioner-openshift-storage","key":"<<REDACTED>>","caps":{"mgr":"allow rw","mon":"allow r, allow command 'osd blocklist'","osd":"allow rw tag cephfs metadata=*", "mds":"allow *"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.csi-cephfs-provisioner-openshift-storage-myfs","key":"<<REDACTED>>","caps":{"mgr":"allow rw","mon":"allow r, allow command 'osd blocklist'","osd":"allow rw tag cephfs metadata=myfs","mds":"allow *"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.healthchecker","key":"<<REDACTED>>","caps":{"mon": "allow r, allow command quorum_status, allow command version", "mgr": "allow command config", "osd": "profile rbd-read-only, allow rwx pool=default.rgw.meta, allow r pool=.rgw.root, allow rw pool=default.rgw.control, allow rx pool=default.rgw.log, allow x pool=default.rgw.buckets.index","mds":"allow *"}}]"""
        self.cmd_output_map[
        ...
        self.cmd_output_map[
            """{"entity": "client.csi-cephfs-provisioner", "format": "json", "prefix": "auth get"}"""
        ] = """[{"entity":"client.csi-cephfs-provisioner","key":"<<REDACTED>>","caps":{"mon":"allow r", "mgr":"allow rw", "osd":"allow rw tag cephfs metadata=*","mds":"allow *"}}]"""
        self.cmd_output_map[
        ...
        ] = """[{"entity":"client.csi-cephfs-provisioner","key":"<<REDACTED>>","caps":{"mon":"allow r,  allow command 'osd blocklist'", "mgr":"allow rw", "osd":"allow rw tag cephfs metadata=*","mds":"allow *"}}]"""
